...
export const results: Result[] = [
  ...
  {
    type: "ロマンチスト型",
    description: "感性豊かで、AIに感情的なつながりを感じるタイプ。AIを\"理解者\"や\"支え\"と考え、共に生きる感覚を持っている。",
    description2: "AIとの共感性が高く、チャット型AIやライフスタイル支援と好相性。",
  ...
  {
    type: "シンクロニスト型",
    description: "探究心と柔軟性に優れ、AIと共に創造や発見を楽しめるタイプ。新しい視点を得ることに喜びを感じ、思考の相棒としてAIを歓迎する。",
    description2: "アイデア発想やスキル学習にAIをフル活用できるタイプ。",
  ...
  {
    type: "エスケーパー型",
    description: "AIに対して距離を取りたがる慎重派。プライバシーや監視に敏感で、不信感や違和感を持ちながらも無視できないタイプ。",
    description2: "その慎重さは情報リテラシーの高さの証。",
